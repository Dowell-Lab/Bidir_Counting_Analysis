...
### Usage
* **Note**: -work-dir is a nextflow argument, not main.nf argument, hence make sure it is donw with -work-dir (not --work-dir) otherwise, it will create a working directory in the folder where you run the command
```
